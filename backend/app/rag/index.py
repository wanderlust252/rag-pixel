...
from app.rag.metadata import REGISTRY_FILENAME, detail_from_metadata, summary_from_metadata
...
class RagIndexService:
    ...
    def list_documents(self) -> list[DocumentSummary]:
        return [summary_from_metadata(metadata) for metadata in self._read_registry()]
